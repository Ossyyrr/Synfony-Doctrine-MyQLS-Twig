...
class ComentariosRepository extends ServiceEntityRepository
{
    ...
    //HACIENDO METODO; ACABARLO
   public function BuscarTodosLosComentarios() 
    {
        return $this->getEntityManager()
            ->createQuery(
                'SELECT comentarios.comentario comentarios.fecha_publicacion, post.id FROM App:Comentarios comentarios JOIN comentarios.posts post
            ');
    }
